...
//             GridTools.WordIntoLine(new WordRequest(property.FindPropertyRelative("word").stringValue, (PlacementType)property.FindPropertyRelative("placementType").enumValueIndex), true, false);
//         }
//
